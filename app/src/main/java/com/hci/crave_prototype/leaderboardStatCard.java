 ...
 */
public class leaderboardStatCard extends LinearLayout {
    ...
    public leaderboardStatCard(Context context) {
        super(context);
        init(null, 0);
    }

    public leaderboardStatCard(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public leaderboardStatCard(Context context, AttributeSet attrs, int defStyle) {
